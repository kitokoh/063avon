...
class FaceMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        instance_action = QAction(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('Instance'), self)
        ...
        media_action = QAction(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('Media'), self)
        ...
        group_action = QAction(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('Group'), self)
        ...
        about_action = QAction(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('About'), self)
        about_action.setToolTip(self.tr('Informations sur l\'application'))
        about_action.triggered.connect(self.open_about)
        menubar.addAction(about_action)

        certificate_action = QAction(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('Certif'), self)
        ...
        settings_menu = menubar.addMenu(QIcon("resourses/icons/facebook-icon-png-745.png"), self.tr('Param'))
    ...
    def switch_language(self, language):
        ...
        if language == "en":
            self.translator.load("lan/en_US/modules/main_fb_robot.qm")
        elif language == "fr":
            self.translator.load("lan/fr_FR/modules/main_fb_robot.qm")
        elif language == "tr":
            self.translator.load("lan/tr_TR/modules/main_fb_robot.qm")
        elif language == "ar":
            self.translator.load("lan/ar_AR/modules/main_fb_robot.qm")
