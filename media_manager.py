...
class MediaTable(QWidget):
 ...
 # Ajouter le menu secondaire
        ...
        self.add_media_button.setIcon(QIcon('icons/add_icon.png'))  # Spécifiez le chemin de votre icône ici
        ...
        self.prev_button.setIcon(QIcon('icons/prev_icon.png'))  # Spécifiez le chemin de votre icône ici
        self.prev_button.clicked.connect(self.prev_page)
        pagination_layout.addWidget(self.prev_button)

        self.next_button = QPushButton('Suivant', self)
        self.next_button.setIcon(QIcon('icons/next_icon.png'))  # Spécifiez le chemin de votre icône ici
    ...
    def add_new_media(self):
       ...
       # QMessageBox.information(self, "Ajout de média", "Fonctionnalité d'ajout de média à implémenter.", QMessageBox.Ok)
